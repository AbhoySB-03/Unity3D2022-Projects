...
public class FootIKSolver : MonoBehaviour
{
    ...
    private void ResolveIK()
    {
        ...
        var targetRotation = GetRotationRootSpace(Target);
            ...
            if ((targetPosition - GetPositionRootSpace(Bones[0])).magnitude >= CompleteLength+footDeltaHeight)
            {
    ...
    public bool CanPlaceFoot()
    {
        return Physics.Raycast(Root.transform.position, Vector3.down, CompleteLength, Ground);
    }
