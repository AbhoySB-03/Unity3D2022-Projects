...
public class MenuScript : MonoBehaviour
{
    ...
    [SerializeField] private Slider grassDensity;
    [SerializeField] private Slider grassDistance;
    ...
    void LoadSettings()
    {
        ...
        grassDensity.value = 0.5f;
        grassDistance.value = 0.5f;
    }
    ...
    public void ApplyChanges()
    {
        ...
        Terrain.activeTerrain.detailObjectDensity = grassDensity.value;
        Terrain.activeTerrain.detailObjectDistance= grassDistance.value * 250;
